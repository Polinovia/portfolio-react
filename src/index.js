...
// Bounce those over to /admin (preserving the hash) so AdminApp - which
...
// Only the /admin route needs the admin auth/moderation code, so load it
// lazily - regular visitors shouldn't pay for that bundle weight.
